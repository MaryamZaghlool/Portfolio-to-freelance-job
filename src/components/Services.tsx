  ...
  const services = [
    {
      ...
      title: 'תרגום מעברית לאנגלית וערבית',
      description: 'תרגום מדויק של מסמכים, טקסטים, מאמרים ותוכן שיווקי בין עברית, אנגלית וערבית, ולהיפך.'
    },
    {
    ...
    },
    {
      ...
      description: 'תרגום אתרים, דפי נחיתה ותוכן דיגיטלי להרחבת קהל היעד שלך בערבית, אנגלית או דוברת עברית.'
    },
       {
